...
import PerformanceSection from "./pages/Students/TeacherReviewSection.jsx";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route exact path="/admin/ratings" element={<TeacherReviewSection />} />
