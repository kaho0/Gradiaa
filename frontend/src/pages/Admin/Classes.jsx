...
const Classes = () => {
  ...
  const fetchClasses = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/class/getall`);
  ...
  const handleAddClass = async (e) => {
    ...
    if (newClassName.trim() !== '') {
      try {
        const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/class`, { grade: newClassName });
